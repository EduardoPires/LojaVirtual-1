...
1. **Clone o Repositório:**
   - `[git clone https://github.com/JOSER1CARDO/LojaVirtual]`

2. **Configuração do Banco de Dados:**
   - No arquivo `appsettings.json`, ja esta configurado para o sqlite

3. **Executar a Aplicação MVC:**
   - `cd src/Blog.Mvc/`
   - `dotnet run`
   - Acesse a aplicação em: https://localhost:44360

4. **Executar a API:**
   - `cd src/Blog.Api/`
   - `dotnet run`
   - Acesse a documentação da API em: https://localhost:44398/swagger/index.html
...
[http://localhost:44364/swagger](https://localhost:44398/swagger/index.html)
